...
public class Pipe : MonoBehaviour
{
    ...
    public void Init(int pipe)
    {
        ...
        if (PipeType == 1 || PipeType == 10||PipeType == 11||PipeType == 12)
        {
            rotation = pipe % 10;
        }
        else
        ...
        if (PipeType == 0 || PipeType == 10||PipeType == 11||PipeType == 12)
        {
            IsFilled = true;
        }
    ...
    public void UpdateInput()
    {
        ...
        .DORotate(new Vector3(0, 0, rotation * rotationMultiplier), 0.3f, RotateMode.Fast)
        .SetEase(Ease.OutQuad);
    }

    public void UpdateFilled()
    {
        if (PipeType==0|| PipeType == 10||PipeType == 11||PipeType == 12)  return;
        emptySprite.gameObject.SetActive(!IsFilled);
        filledSprite.gameObject.SetActive(IsFilled);
    }
